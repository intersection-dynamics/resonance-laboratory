...
Independent research examining whether local quantum field theory — including spacetime geometry, causality, and fermionic statistics — emerges as a stable attractor of unitary evolution on generic entangled states in finite-dimensional Hilbert space.

**Scope (November 2025)**  
A minimal, open-source engine that implements:
...
From these three ingredients alone, the framework reproducibly exhibits:
